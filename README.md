...
## Giới thiệu
Dự án này tập trung vào việc xây dựng mô hình học sâu (Deep Learning) để phân loại bệnh trên lá đậu bằng hình ảnh. Chúng tôi thực hiện huấn luyện và đánh giá trên 4 mô hình khác nhau, bao gồm một mô hình CNN tự xây dựng và 3 mô hình Transfer Learning phổ biến.
